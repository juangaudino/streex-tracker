...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Operations Snapshot now includes attributed Quick Updates while a shift is still open, refreshes live duration, and keeps paused time outside the calculation",
      "Same-weekday comparisons now separate total output from weighted hourly efficiency, including the honest Short day, strong efficiency state",
      "Exact ride time must fall inside a worked block of the selected shift and cannot be assigned during a pause",
