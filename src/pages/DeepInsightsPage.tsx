...
export default function DeepInsightsPage() {
  const { weeks, earningsSnapshots, earningsAttributions, operationalSnapshots, rideEvents, rideUpdateBatches, rideUpdateBatchEvents, ridePayments, rideSnapshotAllocations, manualRideAllocations, zoneLabels, saveZoneLabel, settings, user } = useOutletContext<StoreContext>();
  ...
  const zoneData = useMemo(
    () => buildZoneIntelligenceData({ rideEvents, rideUpdateBatches, rideUpdateBatchEvents, ridePayments, rideSnapshotAllocations, manualRideAllocations, earningsSnapshots, filters }),
    [earningsSnapshots, filters, manualRideAllocations, rideEvents, ridePayments, rideSnapshotAllocations, rideUpdateBatchEvents, rideUpdateBatches],
  );
  useEffect(() => {
